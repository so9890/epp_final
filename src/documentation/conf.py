...
sys.path.append('../../src/data_management/data_functions')
...
project = u"Real consumption inequality and monetary policy"
copyright = u"2019-, Sonja Dobkowitz"
...
latex_documents = [(
    ...
    "Documentation of the Real consumption inequality and monetary policy project",
    "Sonja Dobkowitz",
    "manual"
)]
